...
function directionsFunc() {
  ...
  console.log(dest);
  console.log(source);
  document.getElementById("newMap").innerHTML = "<div><iframe width=60% height=500px frameborder=\"0\" style=\"border:0\"  scrolling=\"auto\" src = \"https://www.google.com/maps/embed/v1/directions?key=AIzaSyA5A-5qiyE0LJgG7_Ns5U2jZ422hvX4sGg&origin=" + source + "&destination=" + dest + "&mode=transit\" allowfullscreen > </iframe ></div> ";
}
